...
while num <= 10:
    if num%2==0: # This line is in the while loop
        print(num) # This line is in the while as in the if statement
    num +=1        # This line is in the while loop

# Line below is there for understand what value the variable num will take after the loop above.
print(num) # 11

# From 1 to 20 inclusive, print every odd number in following format
# "This is an odd number {value of numbber}"
