...
# If statment will execute the next line only when the given condition is True
...
# line number 1 and 2 is inside the if statement so they depennd on condition, but
