...
nuber_of_teachers = 12

# create a string that shows number of teachers and number of students

s = " The total number of teacher is{} and  the total number of student is {}"
print(s.format(number_of_teachers,number_of_student))

# Using the index numbers for formatting the string.
...
S = f"Total number of teachers is{number_of_teachrs}"
