...
# Ask user to enter a positive integeer number
# Check if the given number is within 2 of 10.
# If it is within 2 of a multiple 10 print
# Your number is wihtin 2 of a multiple 10
...
# If the given number remainder with 10 is less than equals 2
...
# The given number is within 2 a multiple 10
...
if remainder>=8 or remainder<=2:
    print("your number is whithin 2 of a multiple 10")
else:
