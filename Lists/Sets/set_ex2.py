...
print(max(s2))
print(min(s)*max(s2))
#find out min number from the s and multiply wiht the max number of s2
min =-200
max1 = 0
# in the first iteration of the loop i should change the value of the min but later on I should only change
#it when the min is bigger that the number
